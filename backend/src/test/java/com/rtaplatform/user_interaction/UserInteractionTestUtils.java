...
public class UserInteractionTestUtils {
    ...
    public static final List<UserInteraction> LIST_UNIQUE_USER_INTERACTION_BY_PRODUCT_ID_1 =
            LIST_USER_INTERACTION_ENTITIES_BY_PRODUCT_ID_1.stream()
                    .map(UserInteractionEntity::toModel)
                    .collect(Collectors.toList());
    public static final Integer N_OF_UNIQUE_USERS_BY_PRODUCT_ID_1 = LIST_USER_INTERACTION_ENTITIES_BY_PRODUCT_ID_1.size();
    public static final List<UserInteractionEntity> LIST_UNIQUE_USER_INTERACTION_ENTITIES_BY_PRODUCT_ID_2 =
            List.of(
    ...
    public static final Integer N_OF_UNIQUE_USERS_BY_PRODUCT_ID_2 = LIST_UNIQUE_USER_INTERACTION_ENTITIES_BY_PRODUCT_ID_2.size();
